...
const withBlockerAndroid: ConfigPlugin = (config) => {
...
function upsertByName<T extends { $: { 'android:name': string } }>(items: T[], name: string, next: T): T[] {
...
export default withBlockerAndroid;
