...
class FilterVpnService : VpnService() {
  ...
  companion object {
    ...
    private val safeSearchMap = mapOf(
      // Google — global + regional variants
      ...
      "news.google.com"    to "forcesafesearch.google.com",
      ...
      "google.be"          to "forcesafesearch.google.com",
      "google.at"          to "forcesafesearch.google.com",
      "google.ch"          to "forcesafesearch.google.com",
      "google.se"          to "forcesafesearch.google.com",
      "google.no"          to "forcesafesearch.google.com",
      "google.dk"          to "forcesafesearch.google.com",
      "google.fi"          to "forcesafesearch.google.com",
      "google.pt"          to "forcesafesearch.google.com",
      "google.com.au"      to "forcesafesearch.google.com",
      "google.ca"          to "forcesafesearch.google.com",
      "google.co.nz"       to "forcesafesearch.google.com",
      ...
      "google.com.co"      to "forcesafesearch.google.com",
      "google.com.pe"      to "forcesafesearch.google.com",
      ...
      // Yandex
      "yandex.com"         to "familysearch.yandex.com",
      "www.yandex.com"     to "familysearch.yandex.com",
      "yandex.ru"          to "familysearch.yandex.ru",
      "www.yandex.ru"      to "familysearch.yandex.ru"
    )
