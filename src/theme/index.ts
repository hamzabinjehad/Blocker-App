...
export const typography = {
  display: { fontSize: 36, fontWeight: '500' as const, letterSpacing: 0 },
  h1: { fontSize: 28, fontWeight: '500' as const, letterSpacing: 0, lineHeight: 34 },
  h2: { fontSize: 21, fontWeight: '500' as const, letterSpacing: 0, lineHeight: 27 },
  h3: { fontSize: 16, fontWeight: '500' as const, letterSpacing: 0, lineHeight: 21 },
